...
def main():
    YAML_PATH = r"/workspace/DiffuAug/exp_settings/configs/classification/aug_test_setttings/patient/resnet18_total_normal_aug.yaml"
    OPTION = "test"
    ...
    if OPTION == "train":
        ...
        pred_result_csv_path = r"/data/results/classification/exps/aug/patients/normal_aug/predict_result/predicted_best_31.csv"
